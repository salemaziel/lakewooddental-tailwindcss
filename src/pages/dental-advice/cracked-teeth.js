...
const CrackedTeeth = () => (
    <Layout>
        <BlogPost
            ...
            post={[
                <>
                    <h3 className="py-4 my-2 text-xl font-bold leading-normal tracking-normal text-center text-dark-blue-500 lg:mb-4"> What does a cracked tooth feel like?</h3>
                    <p>Many teeth, when carefully viewed, may exhibit small crack lines in the enamel. A more deeply cracked tooth may become noticeable when you feel a sharp pain when chewing food or with having a hot or cold drink. It is sometimes difficult to tell which tooth hurts or whether the pain comes from an upper or lower tooth.
                    </p>
                    <p>
                        A crack in a tooth may appear nearly invisible as a hairline fracture or, if prominent, as a stained vertical line. Fractures are generally not visible on X-rays and are diagnosed and located by selective bite and temperature testing of teeth, trans-illumination, visual detection, and by the history of symptoms.</p>
                    <h3 className="py-4 my-2 text-xl font-bold leading-normal tracking-normal text-center text-dark-blue-500 lg:mb-4">Why does a cracked tooth hurt?</h3>
                    <p>
                    ...
                    <h3 className="py-4 my-2 text-xl font-bold leading-normal tracking-normal text-center text-dark-blue-500 lg:mb-4">What causes cracks to develop?</h3>
                    <p>A tooth may crack due to:</p>
                    <ul>
                        <li>Chewing on hard objects or foods such as ice, nuts, or hard candy</li>
                        <li>Tooth weakened by large restorations</li>
                        <li>Tooth structure weakened by significant wear and fatigue</li>
                        <li>Grinding and clenching of teeth</li>
                        <li>Uneven chewing pressure from uneven bite, tipped tooth position, or chewing on one side</li>
                        <li>Exposure of tooth enamel to temperature extremes such as hot coffee and ice water</li>
                        <li>Accidental injury to the teeth</li>
                    </ul>

                    <h3 className="py-4 my-2 text-xl font-bold leading-normal tracking-normal text-center text-dark-blue-500 lg:mb-4">How are cracked teeth treated?</h3>
                    <p>A cracked tooth is treated by replacing the cracked enamel in a way to engulf the entire crack and prevent further splitting of the tooth. Depending on the tooth and on the size and location of the crack, treatment typically involves making a crown or a bonded porcelain veneer to replace the enamel of the tooth and hold the crack together. Endodontic treatment may become necessary if the pulp is irreversibly damaged. If the crack is extremely deep, the only option may be extraction.
                    </p>
