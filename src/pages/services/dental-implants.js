...
<ServiceTemplate
            ...
            post={[
                <>
                    ...
                    <p>
                        <h5 className=""> <strong>Implant placement: </strong></h5>  The first step in the implant process is the placement of the implant. You will be referred to a specialist (oral surgeon or periodontist) for the placement of the implant itself.</p>
                    <p>
                    ...
                    <p>
                        <h5 className=""> <strong>Final Prosthesis: </strong></h5>The final step in the process is the attachment of the final prosthetic replacement to the abutment. Our team will create a custom replacement crown, bridge, or denture that matches the shape, size, and color of your natural teeth.</p>
