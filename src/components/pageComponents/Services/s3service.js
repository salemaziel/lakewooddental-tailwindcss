        ...
        <section className="relative left-0 w-full h-full bg-[#EEF5FF]">
            ...
            <div className="w-full md:w-1/2">
                ...
                <div className="w-full p-10 md:w-1/2 ">
                    <h2 className="mb-3 text-4xl font-semibold leading-10" >Restoration</h2>
                    ...
                    <Link to="/services/restoration" type="button" className="mt-8 text-white bg-[#1F3B53] hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-base uppercase px-16 py-2.5 mr-2 mb-2 dark:bg-[#1F3B53] dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"> Know More</Link>
                </div>
