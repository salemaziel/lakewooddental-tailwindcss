...
const SerLast = (props) => {
    return (
        <section classname="">
            ...
            <div className="w-full pt-24 pb-16 bg-center bg-cover sm:pt-36 backdrop-blur-md h-96"  style={{backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.7), rgba(0,0,0,0.8)), url(${props.bgImage})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
