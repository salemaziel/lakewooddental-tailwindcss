...
const Hero = (props) => {
    return (
        <section classname="">
        <Banner />
            <div className="pt-24 pb-16 bg-center bg-cover sm:pt-36 backdrop-blur-md" style={{backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url(${props.bgImage})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", minHeight: '70vh'}}>
                <div className="container px-4 pt-12 mx-auto">
                    <div className="max-w-3xl mx-auto text-center xl:max-w-4xl">
                        ...
                        <p className="max-w-md mx-auto mb-10 text-2xl leading-8 tracking-wide text-white md:max-w-4xl uppercase">Proudly Serving the Lakewood area for over 20 years.</p>
