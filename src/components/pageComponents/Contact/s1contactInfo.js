...
<section className="pt-20 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
  <div className="container px-4 mx-auto">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3313.0991211091873!2d-118.12580078478994!3d33.8613362806583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dd328550d82d57%3A0xcd6e873311a753e1!2s5828%20Adenmoor%20Ave%2C%20Lakewood%2C%20CA%2090713!5e0!3m2!1sen!2sus!4v1679526373624!5m2!1sen!2sus" /*width={600} height={450}*/ allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="relative object-cover w-full mx-auto -mb-32 border-0 rounded-lg shadow-xl h-72 md:h-128 md:-mb-80" />

    {/*<img className="relative object-cover mx-auto -mb-32 h-72 md:h-auto md:-mb-80" src="flex-ui-assets/images/contact/contact-map.png" alt />*/}
  </div>
  {/*<div className="h-2 bg-logo-blue-500" />*/}
  <div className="py-24 md:py-64 bg-logo-blue-500" style={{backgroundImage: 'url("../../flex-uii-assets/elements/pattern-dark.svg")', backgroundPosition: 'center'}} />
</section>
