		...
		<section className="relative left-0 w-full h-full bg-[#EEF5FF]">
			<div className="container relative px-4 py-12 mx-auto">
				<div className="text-center md:w-3/4 mx-auto w-full">
					...
					<p className="text-[#4294C2] text-lg font-normal leading-9 mt-4 after:block after:border-2 after:border-[#4294C2] after:w-20 after:mt-4 after:mb-10 after:mx-auto">
						In addition to accepting your indemnity dental insurance
						we are happy to be Preferred Providers for the following
				...
				<div className="flex flex-wrap -mx-4 mt-5">
					{props.items.map((item, index) => (
						<div
							className="w-full px-4 mb-6 md:w-1/4 md:mb-0"
							key={index}
						>
