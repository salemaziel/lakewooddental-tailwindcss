            ...
            <div className="container relative max-w-2xl px-4 py-12 mx-auto lg:max-w-5xl">
                <div className="px-4 text-start">
                    ...
                    <p className="text-[#323232] text-base font-normal leading-9 mt-4 ">
                        We accept any dental insurance plan that allows you to see the dentist of your choice. We do accept insurance assignments and we will bill your insurance company for you. However, you are responsible for payment of any dental treatment that is provided and not paid for by your dental insurance. </p>
