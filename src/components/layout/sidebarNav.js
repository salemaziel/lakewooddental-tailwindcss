...
*/
  ...
  return (
    <>
      ...
      {/*Top Bar */}
      <nav className="">
        <div className={(scroll ? `fixed shadow ` : "static ") + (show ? ` sticky ` : " " ) + "z-50 flex rounded-b-lg items-center justify-between w-full p-4 text-gray-800 bg-white lg:hidden hover:text-black focus:outline-none focus:text-black"}>
        ...
        <div id="Main" className={(show ? "translate-x-0 " : " -translate-x-full ") + "bg-white transform lg:translate-x-0 ease-in-out transition duration-500 flex fixed lg:w-72 justify-start lg:justify-evenly overflow-y-hidden overscroll-y-contain bg-fixed container items-start w-full z-40 flex-col max-h-fit h-full"}>
          {/* Logo */}
          <Link to="/" className={(show ? "" : "" ) + ` flex items-center justify-start w-full px-6 pt-6 space-x-3 text-gray-800 xl:flex hover:text-black focus:outline-none focus:text-black`}>
          ...
          <div className="flex flex-col items-start justify-start w-full px-4 py-3">
            ...
            {/* Nav Links */}
            <Link to="/" activeClassName=" underline text-[#4294C2]" className="flex items-center justify-start w-full py-3 pl-4 space-x-6 text-gray-600 rounded focus:outline-none ">

              <span className="text-base leading-4 md:text-md ">Home</span>
            </Link>
            <Link to="/services" className="flex items-center justify-start w-full py-3 pl-4 space-x-6 text-gray-600 rounded focus:outline-none ">

              <p className="text-base leading-4 md:text-md ">  Services</p>
            </Link>
            <Link to="/fees-and-insurance" className="flex items-center justify-start w-full py-3 pl-4 space-x-6 text-gray-600 rounded focus:outline-none ">

              <p className="text-base leading-4 md:text-md">Fees &amp; Insurance</p>
            </Link>
            <Link to="/dental-advice" className="flex items-center justify-start w-full py-3 pl-4 space-x-6 text-gray-600 roundedfocus:outline-none ">

              <p className="text-base leading-4 md:text-md ">Dental Advice</p>
            </Link>
            <Link to="/page-2" className="flex items-center justify-start w-full py-2 pl-3 space-x-6 text-gray-600 roundedfocus:outline-none ">
          ...
          <div className="flex flex-col items-start justify-start w-full px-4 pb-5 mt-2 space-y-3 ">
            <div className="flex items-center justify-start w-full pt-5 py-1 pl-4 text-gray-600 rounded focus:outline-none ">
          ...
          <div className=" mt-0 py-0  flex bg-white justify-center text-center space-x-2 align-top items-center h-auto  px-3.5 w-full">
            <div className="flex flex-col items-center justify-center  align-top">
              ...
              <Link to="#" aria-label="visit" className="w-full focus:ring-2 text-white p-2.5 bg-logo-blue-500 rounded-full">
                Pay Now
              </Link>
            </div>
